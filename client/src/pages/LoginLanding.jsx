...
const LoginLanding = () => {
  ...
  if(user) return <Navigate to={user.mustChangePassword || user.forcePasswordChange ? "/change-password" : "/dashboard"} />
    ...
    const portalOptions = [
        { to: "/login/admin", title: "Admin Portal", description: "Manage employees, attendance, leave, clients, and operations.", icon: ShieldIcon },
        { to: "/login/employee", title: "Employee Portal", description: "View your profile, track attendance, request leave, and manage client work.", icon: UserIcon }
    ]
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
            <div className="mb-10 text-center md:text-left">
                ...
                <p className="text-slate-500">Select your portal to securely access SharpKode Workforce.</p>
            </div>
            ...
            <div className="mt-12 text-center md:text-left text-sm text-slate-400">
                <p>© {new Date().getFullYear()} SharpKode. All rights reserved.</p>
            </div>
        </div>
        </div>
    </div>
