  ...
  return (
    <div className="hidden md:flex w-1/2 bg-indigo-950 relative overflow-hidden border-r border-slate-200">
        ...
        <div className="relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full">
            <h1 className="text-4xl lg:text-5xl font-medium text-white mb-6 leading-tight tracking-tight">SharpKode <br /> Workforce</h1>
            <p className="text-slate-400 text-lg max-w-md leading-relaxed">Manage teams, GPS attendance, leave, clients, visits, and daily operations securely.</p>
        </div>
    </div>
  )
}
